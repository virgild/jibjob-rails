...
(function(global) {
  ...
  global.JibJob.ResumeListItem = React.createClass({
    propTypes: {
    ...
    render: function() {
      ...
      return (
        <div className="col-md-3 col-sm-4 col-xs-12">
          <div id={resumeId} className="resume-list-item" onTouchStart={this.touchStart} onTouchEnd={this.touchEnd} onTouchCancel={this.touchCancel}>
