...
set :linked_files, fetch(:linked_files, []).push('config/database.yml', 'config/secrets.yml', 'config/newrelic.yml', 'config/mailer.yml')
...
set :sidekiq_queue, ['default', 'logging']
